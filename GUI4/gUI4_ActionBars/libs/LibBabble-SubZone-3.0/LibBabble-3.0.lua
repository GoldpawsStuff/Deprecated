...
local LibBabble = GP_LibStub:NewLibrary(LIBBABBLE_MAJOR, LIBBABBLE_MINOR)
...
Example:
	local B = GP_LibStub("LibBabble-Module-3.0") -- where Module is what you want.
...
function LibBabble:New(namespace, minor)
	local module, oldminor = GP_LibStub:NewLibrary(namespace, minor)
	if not module then
		return
	end
