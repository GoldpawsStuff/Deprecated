...
local module = parent:NewModule("FocusTarget", "GP_AceEvent-3.0")
...
function module:OnInitialize()
	self.db = parent.db:RegisterNamespace("FocusTarget", defaults)
...
function module:OnEnable()
	self:AddUnit("focustarget", scaffolding, self.db.profile)
end
