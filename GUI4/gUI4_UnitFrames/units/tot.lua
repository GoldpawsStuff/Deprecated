...
local module = parent:NewModule("ToT", "GP_AceEvent-3.0")
...
function module:OnInitialize()
	self.db = parent.db:RegisterNamespace("ToT", defaults)
...
function module:OnEnable()
	if not self.loaded then
		self:AddUnit("targettarget", scaffolding, self.db.profile)
		self.loaded = true
	end
end
