...
local module = parent:NewModule("ToTTarget", "GP_AceEvent-3.0")
...
function module:OnInitialize()
	self.db = parent.db:RegisterNamespace("ToTTarget", defaults)
...
function module:OnEnable()
	self:AddUnit("targettargettarget", scaffolding, self.db.profile)
end
