...
local ACEDBO_MAJOR, ACEDBO_MINOR = "GP_AceDBOptions-3.0", 15
local AceDBOptions, oldminor = GP_LibStub:NewLibrary(ACEDBO_MAJOR, ACEDBO_MINOR)
...
-- options.args.profiles = GP_LibStub("GP_AceDBOptions-3.0"):GetOptionsTable(self.db)
