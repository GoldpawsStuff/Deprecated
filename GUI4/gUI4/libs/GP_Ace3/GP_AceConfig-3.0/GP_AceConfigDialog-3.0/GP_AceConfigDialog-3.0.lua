...
local MAJOR, MINOR = "GP_AceConfigDialog-3.0", 61
local AceConfigDialog, oldminor = GP_LibStub:NewLibrary(MAJOR, MINOR)
...
local gui = GP_LibStub("GP_AceGUI-3.0")
local reg = GP_LibStub("GP_AceConfigRegistry-3.0")
...
local function ActivateControl(widget, event, ...)
	...
	if type(validated) == "string" then
		...
		PlaySoundKitID(SOUNDKIT.IG_PLAYER_INVITE, "SFX") 
		del(info)
		return true
