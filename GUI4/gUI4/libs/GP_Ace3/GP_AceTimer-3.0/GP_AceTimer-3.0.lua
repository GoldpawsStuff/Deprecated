...
local MAJOR, MINOR = "GP_AceTimer-3.0", 17 -- Bump minor on changes
local AceTimer, oldminor = GP_LibStub:NewLibrary(MAJOR, MINOR)
...
-- @usage
-- MyAddOn = GP_LibStub("GP_AceAddon-3.0"):NewAddon("MyAddOn", "GP_AceTimer-3.0")
--
