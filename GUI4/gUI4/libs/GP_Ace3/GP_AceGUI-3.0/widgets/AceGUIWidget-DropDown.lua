...
do
	...
	local function Constructor()
		...
		local frame = CreateFrame("Frame", "GP_AceGUI30Pullout"..count, UIParent)
		local self = {}
		self.count = count
		...
		local slider = CreateFrame("Slider", "GP_AceGUI30PulloutScrollbar"..count, scrollFrame)
...
do
	...
	local function Constructor()
		...
		local dropdown = CreateFrame("Frame", "GP_AceGUI30DropDown"..count, frame, "UIDropDownMenuTemplate")
