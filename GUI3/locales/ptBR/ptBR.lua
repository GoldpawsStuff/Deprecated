local L = LibStub("gLocale-2.0"):NewLocale((select(1, ...)), "ptBR", false)
...
do
	...
	L["PetBar"] = "Barra de Mascotes" -- *v3
	L["StanceBar"] = "Barra de Posturas" -- *v3
	L["TotemBar"] = "Barra de Totems" -- *v3
	L["MicroMenu"] = "MicroMenu" -- *v3
	L["ActionBar%s"] = "Barra de Ação %s" -- *v3
	L["ExtraActionButton"] = "Botão de Ação Extra" -- *v3
	L["Set to vertical orientation"] = "Define a orientção na vertical" -- *v3
	L["Set to horizontal orientation"] = "Define a orientção na horizontal" -- *v3
	L["Set number of buttons on each row"] = "Define o número de botões em cada linha" -- *v3
	L["Show always"] = "Exibir sempre" -- *v3
	L["Show on mouseover"] = "Exibir ao passar do mouse" -- *v3
	L["Hide always"] = "Esconder sempre" -- *v3	
end
...
do
	...
	L["Micro Menu"] = "Micro Menu" -- *v3
	L["Shapeshift/Aspect/Stance Bar"] = "Barra de Mudança de Forma/Aspecto/Postura" -- *v3
	L["Pet ActionBar"] = "Barra de Ação do Mascote" -- *v3
	L["Leftmost Side ActionBar [5]"] = "Exibir a Barra de Ação mais à Esquerda [5]" -- *v3
	L["Rightmost Side ActionBar [4]"] = "Exibir a Barra de Ação mais à Direita [4]" -- *v3
	L["Bottom Right ActionBar [3b]"] = "Exibir Barra de Ação da Direita [3b]" -- *v3
	L["Bottom Left ActionBar [3a]"] = "Exibit Barra de Ação da Esquerda [3a]" -- *v3
	L["Bottom ActionBar [2]"] = "Barra de Ação Inferior [2]" -- *v3
	L["Main ActionBar [1]"] = "Barra de Ação Principal [1]" -- *v3
	
	L["Show the bottom ActionBar [2]"] = "Exibir a Barra de Ação inferior [2]" -- *v3
	L["Show the bottom left ActionBar [3a]"] = "Exibit Barra de Ação esquerda inferior [3a]" -- *v3
	L["Show the bottom right ActionBar [3b]"] = "Exibit Barra de Ação direita inferior [3b]" -- *v3
	...
	L["VehicleExitButton"] = "Botão de Saída de Veículo" -- *v3
	...
	L["Set the size of the bar's buttons"] = "Define o tamanho dos botões das barras" -- *v3
	L["Bar Width"] = "Largura da Barra" -- *v3
	...
	L["Page Switching"] = "Troca de Página" -- *v3
	L["Here you can enable extra pageswitching for the main ActionBar for some classes."] = "Aqui você pode ativar trocas de páginas extras para a barra de Ação principal para algumas classes." -- *v3
	L["Use Druid Prowl Bar"] = "Utilizar a Barra de Espreita do Druida" -- *v3
	L["Enabling this will switch to a separate bar when you use Prowl"] = "Ativando isto trocará a uma barra separada quando você usar Espreitar" -- *v3
	L["Use Warlock Metamorphosis Bar"] = "Utilizar a Barra de Metamorfose do Bruxo" -- *v3
	L["Enabling this will switch to a separate bar when Metamorphosis is active"] = "Ativando isto trocará a uma barra separada quando a Metamorfose estiver ativa" -- *v3
	L["Use Rogue Shadow Dance Bar"] = "Utilizar Barra de Dança das Sombras do Ladino" -- *v3
	L["Enabling this will switch to a separate bar when Shadow Dance is active"] = "Ativando isto trocará a uma barra separada quando a Dança das Sombras estiver ativa" -- *v3
	L["Use Warrior Stance Bars"] = "Utilizar Barras de Postura do Guerreiro" -- *v3
	L["Enabling this will switch to a separate bar for each of your stances"] = "Ativando isto trocará a uma barra separada para cada uma das suas posturas" -- *v3	
end
...
-- Auras
do
	L["Player Buffs"] = "Bônus do Jogador" -- *v3
	L["Player Debuffs"] = "Penalidades do Jogador" -- *v3
	...
	L["Display remaining time as a timer bar instead of text"] = "Exibir o tempo restante como uma barra de timer ao invés de texto" -- *v3
	L["Consolidate Buffs"] = "Consolidar Bônus" -- *v3	
...
do
	...
	L["Layout Presets"] = "Ajustes de Leiaute" -- *v3	
	...
	L["Click here to apply the default layout with categories, sorting and empty space compression."] = "Clique aqui para aplicar o leiaute padrão com categorias, ordenação e compressão de espaço vazio." -- *v3
...
do
	...
	L["I"] = "I" -- Instance (new in 5.1)
	L["IL"] = "LI" -- Instance Leader (new in 5.1)
	L["BG"] = "CB" -- Battleground (deprecated in 5.1)
	L["BGL"] = "LCB" -- Battleground Leader (deprecated in 5.1)
	L["GM"] = "MJ" -- Game Master
end
...
do
	...
	L["<Left-Click to toggle the Calendar>"] = "<Clique-Esquerdo para abrir o Calendário>" -- *v3
end
...
do
	...
	L["Show seconds"] = "Exibir segundos" -- *v3
	L["Use 24 hour time"] = "Utilizar relógio de 24h" -- *v3
	L["Display the server time instead of the local time"] = "Exibir o horário do servidor ao invés do horário local" -- *v3	
	...
	L["Only show the clock when hovering over the Minimap"] = "Apenas exibir o horário ao passar o mouse sobre o Minimapa" -- *v3
	L["Display the current location"] = "Exibir a localidade atual" -- *v3
	L["Only show the current location when hovering over the Minimap"] = "Apenas exibir a localidade atual ao passar o mouse sobre o Minimapa" -- *v3
	L["Display the calendar button"] = "Exibir o botão do calendário" -- *v3
	L["Only show the calendar button when hovering over the Minimap"] = "Apenas exibir o botão do calendário atual ao passar o mouse sobre o Minimapa" -- *v3	
end
...
do
	...
	L["Show Class Colors in Unit Nameplates for enemies"] = "Exibir Cores de Classes nas placas de nomes para inimigos" -- *v3	
...
-- Panels & Backdrops
do
	L["Here you can set the visibility and behaviour of various objects like the XP and Reputation Bars, the Battleground Capture Bars and more. If you wish to change their position, you can unlock them for movement with |cFF4488FF/glock|r."] = "Aqui você pode definir a visibilidade e o comportamento de vários objetos, como as Barras de EXP e Reputação, Barras de Captura de Campos de Batalhas e mais. Se você deseja alterar suas posições, pode destravá-las com |cFF4488FF/glock|r." -- *v3

	L["StatusBars"] = "Barras de Estado" -- *v3
	L["Show the player experience bar."] = "Exibir a barra de experiência do jogador." -- *v3
	L["Show when you are at your maximum level or have turned off experience gains."] = "Exibir quando você está no nível máximo ou desativou os ganhos de experiência." -- *v3
	L["Show the currently tracked reputation."] = "Exibir a reputação rastreada atualmente." -- *v3
	L["Show the capturebar for PvP objectives."] = "Exibir a barra de captura para objetivos JxJ." -- *v3
	L["XP-, Rep- & Capture Bars"] = "Barras de EXP, Rep & Captura" -- *v3

	L["Panels & Backdrops"] = "Painéis e Fundos" -- *v3
	L["Left Infopanel"] = "Painel de Informações Esquerdo" -- *v3
	L["Right Infopanel"] = "Painel de Informações Direito" -- *v3
	L["Bottom Backdrop"] = "Fundo Inferior" -- *v3
	L["Bottom Left Backdrop"] = "Fundo Esquerdo Inferior" -- *v3
	L["Bottom Right Backdrop"] = "Fundo Direito Inferior" -- *v3
	L["Side Backdrop"] = "Fundo Lateral" -- *v3
	
	L["<Left-Click to open all bags>"] = "<Clique-Esquerdo para abrir todas as bolsas>"
	L["<Left-Click to toggle backpack>"] = "<Clique-Esquerdo para abrir/fechar a mochila>"
	...
	L["Home latency %s:"] = "Latência de casa %s:"
	...
	L["<Left-Click to toggle Currency frame>"] = "<Clique-Esquerdo para ativar o painel de Moeda>"
...
-- Panels: menu
do
	L["Here you can change the settings and visibility of the various info panels and backdrops in the UI."] = "Aqui você pode alterar as definições e visibilidade de vários painéis de informações e fundos na IU." -- *v3
	...
	L["Visible Backdrops"] = "Fundos Visíveis" -- *v3
	L["Here you can decide which of the backdrops should be visible."] = "Aqui você pode decidir quais fundos devem ser visíveis." -- *v3
	L["Bottom Backdrop"] = "Fundo Inferior" -- *v3
	L["Bottom Left Backdrop"] = "Fundo Esquerdo Inferior" -- *v3
	L["Bottom Right Backdrop"] = "Fundo Direito Inferior" -- *v3
	L["Side Backdrop"] = "Fundo Lateral" -- *v3	
...
do
	...
	L["Color unit tooltips borders and healthbars according to player class or NPC reaction"] = "Colorir bordas de dicas de unidades e barras de vida de acordo com a classe do jogador ou reação do PNJ" -- *v3	
...
do
	...
	L["Can't change the Set Focus key while engaged in combat!"] = "Não pode alterar a tecla de Definir Foco quando em combate!" -- *v3	
end
...
do
	...
	L["Target"] = "Alvo" -- *v3
	L["Pet"] = "Mascote" -- *v3
	L["Target of Target"] = "Alvo do Alvo" -- *v3
	L["Focus"] = "Foco" -- *v3
	L["Party"] = "Grupo" -- *v3
	L["15 Player Raid"] = "Raide de 15 Jogadores" -- *v3
	L["40 Player Raid Healer"] = "Curador da Raide de 40 Jogadores" -- *v3
	L["40 Player Raid DPS"] = "DPS da Raide de 40 Jogadores" -- *v3
	L["Arena"] = "Arena" -- *v3
	L["Boss"] = "Chefe" -- *v3
end
...
do
	...
	L["Group Structure"] = "Estrutura do Grupo"
	L["Group Roles"] = "Funções do Grupo"
	L["World Markers"] = "Marcadores do Mundo"
...
do
	...
	-- castbars
	L["Player Castbar"] = "Barra de Lançamento do Jogador" -- *v3
	L["Target Castbar"] = "Barra de Lançamento do Alvo" -- *v3
	L["Focus Castbar"] = "Barra de Lançamento do Foco" -- *v3
	L["Pet Castbar"] = "Barra de Lançamento do Mascote" -- *v3	
...
--------------------------------------------------------------------------------------------------
do
	L["Copy settings between characters"] = "Copiar definições entre personagens" -- *v3
	L["Save"] = "Salvar" -- *v3
	L["Restore"] = "Restaurar" -- *v3

	L["Goldpaw"] = "|cFFFF7D0AGoldpaw|r" -- my class colored name. no changes needed here.
	L["%s loaded and ready"] = "%s carregado e pronto" -- *v3
	L["|cFF4488FF/glock|r to activate config mode"] = "|cFF4488FF/glock|r para ativar o modo de configuração" -- *v3
	L["|cFF4488FF/bind|r to activate binding mode"] = "|cFF4488FF/bind|r para ativar o modo de definição de teclas de atalho" -- *v3
	L["|cFF4488FF/gui|r for additional options"] = "|cFF4488FF/gui|r para opções adicionais" -- *v3
	...
	-- keybind stuff
	L["Show Talent Pane"] = "Exibir o Painel de Talentos"
	L["Reload the user interface"] = "Recarregar a interface de usuário" -- *v3
	L["Blizzard Customer Support"] = "Suporte ao Cliente da Blizzard" -- *v3
	L["Toggle movable frames"] = "Ativar/Desativar quadros móveis" -- *v3
	L["Toggle hover keybind mode"] = "Ativar/desativar modo de vínculos de teclas de atalho ao passar do mouse" -- *v3
	L["Additional Keybinds"] = "Teclas de Atalho Adicionais" -- *v3
	L["TSM Post/Cancel"] = "TSM Postar/Cancelar" -- *v3

	-- chat commands
	L["Activating Primary Specialization"] = "Ativando Especialização Primária" -- *v3
	L["Activating Secondary Specialization"] = "Ativando Especialização Secundária" -- *v3
	L["%s has been temporarily disabled. Type /enablegui to enable it."] = "%s foi temporariamente desativado. Digite /enablegui para ativá-lo." -- *v3
	
	-- frame groups (objects movable with /glock)
	L["Unitframes"] = "Quadros de unidades" -- *v3
	L["Frames like the player, target, raid, focus, pet etc"] = "Quadros como o jogador, alvo, raide, foco, mascote, etc" -- *v3
	L["Actionbars"] = "Barras de ação" -- *v3
	L["Frames containing shortcut buttons to abilities, macros etc"] = "Quadros contendo botões de atalho para habilidades, macros, etc" -- *v3
	L["Panels"] = "Painéis" -- *v3
	L["Various UI panels providing information, |rincluding the minimap and bottom left and right infopanels"] = "Vários painéis de IU que fornecem informações, |rincluindo o minimapa e os painéis de informações inferiores esquerdo e direito" -- *v3
	L["Floaters"] = "Flutuadores" -- *v3
	L["Various uncategorized elements like the objective tracker, |rthe durability frame, the vehicle seat indicator etc"] = "Vários elementos sem categoria como o rastreador de objetivos, |ro quadro de durabilidade, o indicador de assento do veículo, etc" -- *v3
	L["Auras"] = "Auras" -- *v3
	L["Your buffs and debuffs"] = "Seus bônus e penalidades" -- *v3
	L["Castbars"] = "Barras de lançamento" -- *v3
	L["Unit castbars, mirror timers, BG timers, etc"] = "Barras de lançamento de unidades, timers espelhos, timers de CB, etc" -- *v3
	
	-- floaters (various movable frame names)
	L["Vehicle"] = "Veículo" -- *v3
	L["Objectives"] = "Objetivos" -- *v3
	L["Alternate Power"] = "Poder Alternativo" -- *v3
	L["Tickets"] = "Tickets" -- *v3
	L["Durability"] = "Durabnilidade" -- *v3
	L["Ghost"] = "Fantasma" -- *v3
	L["WorldStateScore"] = "Placar do Estado do Mundo" -- *v3
	L["ExtraActionButton"] = "Botão Extra de Ação" -- *v3
	L["Achievement and Dungeon Alert Frame"] = "Quadro de Conquistas e Alerta de Masmorras" -- *v3
	
	-- auto disable
	L["The '%s' module was disabled due to the addon '%s' being loaded."] = "O módulo '%s' foi desativado devido ao addon '%s' estar carregado." -- *v3	

	-- skin names and descriptions
	L["Skins"] = "Temas" -- *v3
	L["Skins the '%s' addon"] = "Tematiza o addon '%s'" -- *v3
	L["Here you can decide which elements should be skinned to match the rest of the UI, and which should keep their default appearance."] = "Aqui você define quais elementos devem ser tematizados para combinar com o resto da IU, e quais devem manter suas aparências originais." -- *v3
	L["Debug Tools"] = "Ferramentas de Depuração" -- *v3
	L["Debug tools such as the /framestack or /eventtrace frames"] = "Ferramentas de depuração como os quadros /framestack ou /eventtrace" -- *v3
	L["MovePad"] = "MovePad" -- *v3
	L["The movepad which allows you to move and jump with your mouse"] = "O movepad que permite a você se mover e pular com o mouse" -- *v3
	L["Alert Frames"] = "Quadros de Alerta" -- *v3
	L["General alerts such as new achievements, dungeons completed, etc"] = "Alertas gerais como os de novas conquistas, masmorras completadas, etc" -- *v3
	L["Color Picker"] = "Seletor de Cores" -- *v3
	L["The color wheel"] = "A roda de cores" -- *v3
	L["GameMenu"] = "Menu do Jogo" -- *v3
	L["The main game menu"] = "O menu principal do jogo" -- *v3
	L["Ghost"] = "Fantasma" -- *v3
	L["The button returning you to a graveyard as a ghost"] = "O botão de retorno ao cemitério como um fantasma" -- *v3
	L["Quest Gossip"] = "Fofoca de Missão" -- *v3
	L["General gossip when talking to quest givers"] = "Fofocas gerais ao conversar com recrutadores de missões" -- *v3
	L["Merchant"] = "Mercador" -- *v3
	L["The buy/sell window when talking to merchants"] = "A janela de compra/venda ao conversar com mercadores" -- *v3
	L["Opacity"] = "Opacidade" -- *v3
	L["The opacity selector"] = "O seletor de opacidade" -- *v3
	L["Quest Log"] = "Registro de Missões" -- *v3
	L["Main quest log"] = "O registro principal de missões" -- *v3
	L["Quest Greeting"] = "Saudação de Missão" -- *v3
	L["The greeting window when talking to quest givers"] = "A janela de saudação ao conversar com recrutadores de missões" -- *v3
	L["Ready Check"] = "Checagem de Prontidão" -- *v3
	L["The ready check popup when in a group"] = "O popup de checagem de prontidão quando num grupo" -- *v3
	L["Roll Poll"] = "Verificação de Funções" -- *v3
	L["The roll poll popup when in a group"] = "O popup verificador de funções quando num grupo" -- *v3
	L["Stack Split"] = "Divisor de Pilhas" -- *v3
	L["The stack split frame when splitting stacks in your bank or bags"] = "O quadro de divisão de pilhas ao dividir pilhas nos seus banco ou bolsas" -- *v3
	L["Popups"] = "Popups" -- *v3
	L["The popup windows with yes/no or other queries"] = "As janelas de popup com questões sim/não ou outras" -- *v3
	L["Taxi"] = "Taxi" -- *v3
	L["The flight map when talking to flight masters"] = "O mapa de voos ao conversar com mestres de voo" -- *v3
	L["Ticket Status"] = "Estado da consulta" -- *v3
	L["The ticket status button for active support tickets"] = "O botão de estado da consulta para consultas de suporte ativas" -- *v3
	L["Objectives Tracker"] = "Rastreador de Objetivos" -- *v3
	L["The quest- and achievement tracker"] = "O rastreador de missões e conquistas" -- *v3
	L["World Score"] = "Placar do Mundo" -- *v3
	L["The on-screen score (battlegrounds, dungeon waves, world PvP objectives etc)"] = "O placar na tela (campos de batalha, objetivos JxJ mundiais, etc)" -- *v3
	L["Battleground Score"] = "Pontuação do Campo de Batalha" -- *v3
	L["The Battleground score frame"] = "O quadro de pontuação do campo de batalha" -- *v3
	L["Achievements"] = "Conquistas" -- *v3
	L["The achievement- and statistic frames"] = "Os quadros de conquistas e estatísticas" -- *v3
	L["Archeology"] = "Arqueologia" -- *v3
	L["The Archeology UI"] = "A IU de arqueologia" -- *v3
	L["Auction House"] = "Casa de Leilões" -- *v3
	L["The Auction House Interface"] = "A interface da casa de leilões" -- *v3
	L["Barber Shop"] = "Barbearia" -- *v3
	L["The Barber Shop Interface, where you change your hair, facial hair and markings."] = "A interface da barbearia, onde você muda o penteado, pêlos faciais e marcas" -- *v3
	L["Mailbox"] = "Caixa de Correio" -- *v3
	L["Your Mail Inbox and Send Mail windows."] = "Suas janelas de caixa de entrada e saída" -- *v3
	L["Character"] = "Personagem" -- *v3
	L["The window where you see your currently equipped gear, set your title and manage your equipment sets."] = "A janela onde você vê seus equipamentos atuais, define seu título e gerencia seus conjuntos de equipamentos" -- *v3
	L["Guild Bank"] = "Banco da Guilda" -- *v3
	L["The Guild Bank window with your guild's gold and items."] = "A janela do banco da guilda com seu ouro e seus itens" -- *v3
	L["Calendar"] = "Calendário" -- *v3
	L["The in-game calendar"] = "O calendário dentro do jogo" -- *v3
	L["Dressing Room"] = "Vestiário" -- *v3
	L["The dressing room where your character can try on other gear and weapons."] = "O vestiário onde seu personagem pode experimentar outros equipamentos e armas" -- *v3
	L["Autocomplete"] = "Autocompletar" -- *v3
	L["The autocomplete box that pops up when you send mail, invite people to a group etc."] = "A caixa de completar automaticamente ao enviar correio, convidar pessoas a um grupo, etc" -- *v3
	L["TradeSkill"] = "Profissão" -- *v3
	L["The tradeskill windows where you craft items."] = "As janelas de profissões onde você forja itens" -- *v3
	L["ItemText"] = "Texto de Item" -- *v3
	L["The itemtext frame for books, signs, etc."] = "O quadro de texto de itens para livros, sinais, etc" -- *v3
	L["Trade"] = "Troca" -- *v3
	L["The trade window when trading with another player."] = "A janela de troca ao trocar com outro jogador" -- *v3
	L["Void Storage UI"] = "IU de Cofre Etéreo" -- *v3
	L["The Void Storage interface"] = "A interface de cofre etéreo" -- *v3
	L["Tutorials"] = "Tutoriais" -- *v3
	L["The game tutorials for new players"] = "Os tutoriais do jogo para novos jogadores" -- *v3
	L["Transmogrification UI"] = "IU de Transmogrificação" -- *v3
	L["The item transmogrification window where you style your items to look like other items"] = "A janela de transmogrificação de itens onde você estiliza seus itens para parecerem com outros" -- *v3
	L["Trainers"] = "Treinadores" -- *v3
	L["The trainer interface where you learn new skills and abilities from"] = "A interface do treinador onde você aprende novas técnicas e habilidades" -- *v3
	L["Tabard UI"] = "IU de Tabardo" -- *v3
	L["The tabard designer interface"] = "A interface de desenho de tabardos" -- *v3
	L["Socketing UI"] = "IU de Soquetes" -- *v3
	L["The item socketing UI where you add or remove gems from your gear"] = "A IU de soquetes de itens onde você adiciona ou remove gemas de seus equipamentos" -- *v3
	L["Reforging UI"] = "IU de Reforja" -- *v3
	L["The reforging UI where you redistribute secondary stats on your gear"] = "A IU de reforja onde você redistribui os atributos secundários na seu equipamento" -- *v3
	L["PvP"] = "JxJ" -- *v3
	L["The PvP window where you queue up for Battlegrounds and Arenas, and manage your teams"] = "A janela de JxJ onde você entra na fila para Campos de Batalha e Arenas, e gerencia seus times" -- *v3
	L["Petitions"] = "Petições" -- *v3
	L["Petition request such as Guild- and Arena charters"] = "Requisições de petições como privilégios de guilda e arenas" -- *v3
	L["Macro UI"] = "IU de Macro" -- *v3
	L["The window where you manage your macros"] = "A janela onde você gerencia suas macros" -- *v3
	L["Dungeon Journal"] = "Almanaque de Masmorras" -- *v3
	L["Instance descriptions, boss abilities and loot tables"] = "Descrições de instâncias, habilidades de chefes e tabelas de saques" -- *v3
	L["Dungeon Finder"] = "Localizador de Masmorras" -- *v3
	L["Where you browse available dungeons, raids, scenarios and challenges"] = "Onde você navega pela masmorras disponíveis, raides, cenários e desafios" -- *v3
	L["Friends"] = "Amigos" -- *v3
	L["The friends frame"] = "O quadro de amigos" -- *v3
	L["Guild UI"] = "IU da Guilda" -- *v3
	L["The main guild interface"] = "A interface principal de guildas" -- *v3
	L["Guild Control UI"] = "IU do Controle de Guilda" -- *v3
	L["The window where you create, modify and delete the guild ranks and their permissions"] = "A janela onde você cria, modifica e remove os postos da guilda e suas permissões" -- *v3
	L["Guild Finder UI"] = "IU do Localizador de Guildas" -- *v3
	L["The window where you browser for guilds"] = "A janela onde você navega por guildas" -- *v3
	L["Guild Registrar"] = "Registrador de Guilda" -- *v3
	L["The guild registrar interface where you buy petitions and create new guilds"] = "A interface do escrivão de guildas onde você compra petições e cria novas guildas" -- *v3
	L["Guild Invite"] = "Convite de Guilda" -- *v3
	L["The guild invite frame where you accept or decline a guild invitation"] = "O quadro de convite de guildas onde você aceita ou rejeita o convite da guilda" -- *v3
	L["Inspect UI"] = "IU de Inspeção" -- *v3
	L["The window where you inspect another player's gear, talents and PvP teams"] = "A janela onde você inspeciona o equipamento de outro jogador, os talentos e times de JxJ" -- *v3
	L["Black Market UI"] = "IU do Mercado Negro" -- *v3
	L["The black market interface"] = "A interface do mercado negro" -- *v3
	L["Item Upgrade UI"] = "IU de Melhoramento de Item" -- *v3
	L["The window where you upgrade the item level of your gear"] = "A janela onde você melhora o nível do item do seu equipamento" -- *v3
end

-- menu
do
	L["Copy settings from another character"] = "Copiar definições de outro personagem"
	L["This will copy all settings for the addon and all its sub-modules from the selected character to your currently active character"] = "Isto copiará todas as configurações deste addon e seus sub-módulos do personagem selecionado para seu personagem ativo"
	L["This will only copy the settings for this specific sub-module from the selected character to your currently active character"] = "Isto apenas copiará as definições específicas deste sub-módulo do personagem selecionado para seu personagem ativo"
	...
	L["Global Styles"] = "Estilos Globais" -- *v3
	L["Backdrop Opacity"] = "Opacidade do Fundo" -- *v3
	L["Set the level of transparency for all backdrops"] = "Define o nível de transparência de todos os fundos" -- *v3	
	...
	L["Settings"] = "Definições" -- *v3
	L["Adjust the settings for this module"] = "Ajustar as definições para este módulo" -- *v3
...
do
	...
	L["Changing these settings requires the UI to be reloaded in order to complete."] = "A alteração destas definições requerem que a IU seja recarregada para serem completas." -- *v3
end
...
do
	...
	L["Cancel current position changes"] = "Cancelar mudanças de posição" -- *v3
	L["Reset to default position"] = "Redefinir à posição original" -- *v3
	L["<Left-Click to toggle this category>"] = "<Clique-Esquerdo para ativar/desativar esta categoria>" -- *v3
	L["<Shift-Click to reset all frames in this category>"] = "<Shift-Clique para redefinir todos os quadros nesta categoria>" -- *v3
	L["The frame '%s' is now locked"] = "O quadro '%s' está travado" -- *v3
	L["The group '%s' is now locked"] = "O grupo '%s' está travado" -- *v3
	L["All frames '%s' are now locked"] = "Todos os quadros '%s' estão travados" -- *v3
	L["The frame '%s' is now unlocked"] = "O quadro '%s' está destravado" -- *v3
	L["The group '%s' is now unlocked"] = "O grupo '%s' está destravado" -- *v3
	L["All frames are now unlocked"] = "Todos os quadros '%s' estão destravados" -- *v3
	L["All frames are now locked"] = "Todos os quadros estão travados" -- *v3
	L["No registered frames to unlock"] = "Nenhum quadro registrado para destravar" -- *v3
	L["The group '%s' is empty"] = "O grupo '%s' está vazio" -- *v3
	L["Configuration Mode"] = "Modo de Configuração" -- *v3
	L["Frames are now unlocked for movement."] = "Quadros estão destravados para movimentação." -- *v3
	L["<Left-Click once to raise a frame to the front>"] = "<Clique-Esquerdo uma vez para trazer um quadro à frente>" -- *v3
	L["<Left-Click and drag to move a frame>"] = "<Clique-Esquerdo e arraste para mover um quadro>" -- *v3
	L["<Left-Click+Shift to lock a frame into position>"] = "<Shift+Clique-Esquerdo para travar um quadro na sua posição>" -- *v3
	L["<Right-Click a frame for additional options>"] = "<Clique-Direito num quadro para opções adicionais>" -- *v3
	L["Reset all frames to their default positions"] = "Redefinir todos os quadros às suas posições iniciais" -- *v3
	L["Cancel all current position changes"] = "Cancelar todas as mudanças de posição atuais" -- *v3
	L["Lock all frames"] = "Travar todos os quadros" -- *v3	
end
...
do
	...
	L["CombatLogs"] = "Registros de Combate" -- *v3
	L["Developer Tools"] = "Ferramentas de Desenvolvimento" -- *v3	
	L["Errors"] = "Erros"
	L["Fonts"] = "Fontes" -- *v3	
	L["Loot"] = "Saque"
	L["Map"] = "Mapa" -- *v3	
	...
	L["Panels & Backdrops"] = "Painéis & Fundos" -- *v3	
	L["Quests"] = "Missões"
...
do
	...
	L["_ui_copyright_"] = "Direitos Autorais (c) 2013, Lars '%s' Norberg. Todos os direitos reservados."
end