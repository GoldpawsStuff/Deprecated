local L = LibStub("gLocale-2.0"):NewLocale((select(1, ...)), "enUS", true) -- do NOT set the 'true' flag on any other locales!
if not L then return end

--[[
	Notes on v3 locales:
		Most of the locales are identical to v2 of gUI. 
		The new or changed items have been marked with *v3 as a comment.
		So to easily find all new v3 entries, simply do a search for *v3.
]]--
...
do
	...
	L["TotemBar"] = true -- *v3
	L["MicroMenu"] = true -- *v3
	L["ActionBar%s"] = true -- *v3
	L["ExtraActionButton"] = true -- *v3
	L["Set to vertical orientation"] = true -- *v3
	L["Set to horizontal orientation"] = true -- *v3
	L["Set number of buttons on each row"] = true -- *v3
	L["Show always"] = true -- *v3
	L["Show on mouseover"] = true -- *v3
	L["Hide always"] = true -- *v3
end
...
do
	...
	L["Shapeshift/Aspect/Stance Bar"] = true -- *v3
	L["Pet ActionBar"] = true -- *v3
	L["Leftmost Side ActionBar [5]"] = true -- *v3
	L["Rightmost Side ActionBar [4]"] = true -- *v3
	L["Bottom Right ActionBar [3b]"] = true -- *v3
	L["Bottom Left ActionBar [3a]"] = true -- *v3
	L["Bottom ActionBar [2]"] = true -- *v3
	L["Main ActionBar [1]"] = true -- *v3
	
	L["Show the bottom ActionBar [2]"] = true -- *v3
	L["Show the bottom left ActionBar [3a]"] = true -- *v3
	L["Show the bottom right ActionBar [3b]"] = true -- *v3
	L["Show the rightmost side ActionBar [4]"] = true
	L["Show the leftmost side ActionBar [5]"] = true
	...
	L["VehicleExitButton"] = true -- *v3

	-- L["Show the Totem Bar"] = true -- doesn't exist anymore
	...
	L["Button Size"] = true
	L["Set the size of the bar's buttons"] = true
	L["Bar Width"] = true -- *v3
	...
	L["Page Switching"] = true -- *v3
	L["Here you can enable extra pageswitching for the main ActionBar for some classes."] = true -- *v3
	L["Use Druid Prowl Bar"] = true -- *v3
	L["Enabling this will switch to a separate bar when you use Prowl"] = true -- *v3
	L["Use Warlock Metamorphosis Bar"] = true -- *v3
	L["Enabling this will switch to a separate bar when Metamorphosis is active"] = true -- *v3
	L["Use Rogue Shadow Dance Bar"] = true -- *v3
	L["Enabling this will switch to a separate bar when Shadow Dance is active"] = true -- *v3
	L["Use Warrior Stance Bars"] = true -- *v3
	L["Enabling this will switch to a separate bar for each of your stances"] = true -- *v3
end
...
-- Auras
do
	L["Player Buffs"] = true -- *v3
	L["Player Debuffs"] = true -- *v3
	...
	L["Display remaining time as a timer bar instead of text"] = true -- *v3
	L["Consolidate Buffs"] = true -- *v3
...
do
	...
	L["Bank Column %d Width"] = true
	L["Sets the number of horizontal slots in the given column of bank containers."] = true
	L["Bag Scale"] = true
	...
	L["Click here to apply the default layout with categories, sorting and empty space compression."] = true -- *v3
...
do
	...
	L["<Left-Click to toggle the Calendar>"] = true -- *v3
end
...
do
	...
	L["Show seconds"] = true -- *v3
	L["Use 24 hour time"] = true -- *v3
	L["Display the server time instead of the local time"] = true -- *v3
	...
	L["Only show the clock when hovering over the Minimap"] = true -- *v3
	L["Display the current location"] = true -- *v3
	L["Only show the current location when hovering over the Minimap"] = true -- *v3
	L["Display the calendar button"] = true -- *v3
	L["Only show the calendar button when hovering over the Minimap"] = true -- *v3
end
...
do
	...
	L["Show Class Colors in Unit Nameplates for enemies"] = true -- *v3	
...
do
	...
	L["XP-, Rep- & Capture Bars"] = true -- *v3

	L["Panels & Backdrops"] = true -- *v3
	L["Left Infopanel"] = true -- *v3
	L["Right Infopanel"] = true -- *v3
	L["Bottom Backdrop"] = true -- *v3
	L["Bottom Left Backdrop"] = true -- *v3
	L["Bottom Right Backdrop"] = true -- *v3
	L["Side Backdrop"] = true -- *v3

	L["<Left-Click to open all bags>"] = true
	L["<Left-Click to toggle backpack>"] = true
...
-- Panels: menu
do
	L["Here you can change the settings and visibility of the various info panels and backdrops in the UI."] = true -- *v3
	...
	L["Visible Backdrops"] = true -- *v3
	L["Here you can decide which of the backdrops should be visible."] = true -- *v3
	L["Bottom Backdrop"] = true -- *v3
	L["Bottom Left Backdrop"] = true -- *v3
	L["Bottom Right Backdrop"] = true -- *v3
	L["Side Backdrop"] = true -- *v3
...
do
	...
	L["Color unit tooltips borders and healthbars according to player class or NPC reaction"] = true -- *v3
...
do
	...
	L["Can't change the Set Focus key while engaged in combat!"] = true
end
...
do
	...
	L["Filter the player auras in combat"] = true
	L["This will filter out auras not relevant to your role from the player frame while engaged in combat, to make it easier to track your own auras."] = true
...
do
	...
	L["Target"] = true -- *v3
	L["Pet"] = true -- *v3
	L["Target of Target"] = true -- *v3
	L["Focus"] = true -- *v3
	L["Party"] = true -- *v3
	L["15 Player Raid"] = true -- *v3
	L["40 Player Raid Healer"] = true -- *v3
	L["40 Player Raid DPS"] = true -- *v3
	L["Arena"] = true -- *v3
	L["Boss"] = true -- *v3
	L["Player Class Bar"] = true -- *v3
end
...
--------------------------------------------------------------------------------------------------
do
	L["Copy settings between characters"] = true -- *v3
	L["Save"] = true -- *v3
	L["Restore"] = true -- *v3

	L["Goldpaw"] = "|cFFFF7D0AGoldpaw|r" -- my class colored name. no changes needed here.
	L["%s loaded and ready"] = true -- *v3
	L["|cFF4488FF/glock|r to activate config mode"] = true -- *v3
	L["|cFF4488FF/bind|r to activate binding mode"] = true -- *v3
	L["|cFF4488FF/gui|r for additional options"] = true -- *v3
	...
	L["Reload the user interface"] = true -- *v3
	L["Blizzard Customer Support"] = true -- *v3
	L["Toggle movable frames"] = true -- *v3
	L["Toggle hover keybind mode"] = true -- *v3
	L["Additional Keybinds"] = true -- *v3
	L["TSM Post/Cancel"] = true -- *v3

	-- chat commands
	L["Activating Primary Specialization"] = true -- *v3
	L["Activating Secondary Specialization"] = true -- *v3
	L["%s has been temporarily disabled. Type /enablegui to enable it."] = true -- *v3
	
	-- frame groups (objects movable with /glock)
	L["Unitframes"] = true -- *v3
	L["Frames like the player, target, raid, focus, pet etc"] = true -- *v3
	L["Actionbars"] = true -- *v3
	L["Frames containing shortcut buttons to abilities, macros etc"] = true -- *v3
	L["Panels"] = true -- *v3
	L["Various UI panels providing information, |rincluding the minimap and bottom left and right infopanels"] = true -- *v3
	L["Floaters"] = true -- *v3
	L["Various uncategorized elements like the objective tracker, |rthe durability frame, the vehicle seat indicator etc"] = true -- *v3
	L["Auras"] = true -- *v3
	L["Your buffs and debuffs"] = true -- *v3
	L["Castbars"] = true -- *v3
	L["Unit castbars, mirror timers, BG timers, etc"] = true -- *v3
	
	-- floaters (various movable frame names)
	L["Vehicle"] = true -- *v3
	L["Objectives"] = true -- *v3
	L["Alternate Power"] = true -- *v3
	L["Tickets"] = true -- *v3
	L["Durability"] = true -- *v3
	L["Ghost"] = true -- *v3
	L["WorldStateScore"] = true -- *v3
	L["ExtraActionButton"] = true -- *v3
	L["Achievement and Dungeon Alert Frame"] = true -- *v3
	
	-- auto disable
	L["The '%s' module was disabled due to the addon '%s' being loaded."] = true -- *v3
	
	-- skin names and descriptions
	L["Skins"] = true -- *v3
	L["Skins the '%s' addon"] = true -- *v3
	L["Here you can decide which elements should be skinned to match the rest of the UI, and which should keep their default appearance."] = true -- *v3
	L["Debug Tools"] = true -- *v3
	L["Debug tools such as the /framestack or /eventtrace frames"] = true -- *v3
	L["MovePad"] = true -- *v3
	L["The movepad which allows you to move and jump with your mouse"] = true -- *v3
	L["Alert Frames"] = true -- *v3
	L["General alerts such as new achievements, dungeons completed, etc"] = true -- *v3
	L["Color Picker"] = true -- *v3
	L["The color wheel"] = true -- *v3
	L["GameMenu"] = true -- *v3
	L["The main game menu"] = true -- *v3
	L["Ghost"] = true -- *v3
	L["The button returning you to a graveyard as a ghost"] = true -- *v3
	L["Quest Gossip"] = true -- *v3
	L["General gossip when talking to quest givers"] = true -- *v3
	L["Merchant"] = true -- *v3
	L["The buy/sell window when talking to merchants"] = true -- *v3
	L["Opacity"] = true -- *v3
	L["The opacity selector"] = true -- *v3
	L["Quest Log"] = true -- *v3
	L["Main quest log"] = true -- *v3
	L["Quest Greeting"] = true -- *v3
	L["The greeting window when talking to quest givers"] = true -- *v3
	L["Ready Check"] = true -- *v3
	L["The ready check popup when in a group"] = true -- *v3
	L["Roll Poll"] = true -- *v3
	L["The roll poll popup when in a group"] = true -- *v3
	L["Stack Split"] = true -- *v3
	L["The stack split frame when splitting stacks in your bank or bags"] = true -- *v3
	L["Popups"] = true -- *v3
	L["The popup windows with yes/no or other queries"] = true -- *v3
	L["Taxi"] = true -- *v3
	L["The flight map when talking to flight masters"] = true -- *v3
	L["Ticket Status"] = true -- *v3
	L["The ticket status button for active support tickets"] = true -- *v3
	L["Objectives Tracker"] = true -- *v3
	L["The quest- and achievement tracker"] = true -- *v3
	L["World Score"] = true -- *v3
	L["The on-screen score (battlegrounds, dungeon waves, world PvP objectives etc)"] = true -- *v3
	L["Battleground Score"] = true -- *v3
	L["The Battleground score frame"] = true -- *v3
	L["Achievements"] = true -- *v3
	L["The achievement- and statistic frames"] = true -- *v3
	L["Archeology"] = true -- *v3
	L["The Archeology UI"] = true -- *v3
	L["Auction House"] = true -- *v3
	L["The Auction House Interface"] = true -- *v3
	L["Barber Shop"] = true -- *v3
	L["The Barber Shop Interface, where you change your hair, facial hair and markings."] = true -- *v3
	L["Mailbox"] = true -- *v3
	L["Your Mail Inbox and Send Mail windows."] = true -- *v3
	L["Character"] = true -- *v3
	L["The window where you see your currently equipped gear, set your title and manage your equipment sets."] = true -- *v3
	L["Guild Bank"] = true -- *v3
	L["The Guild Bank window with your guild's gold and items."] = true -- *v3
	L["Calendar"] = true -- *v3
	L["The in-game calendar"] = true -- *v3
	L["Dressing Room"] = true -- *v3
	L["The dressing room where your character can try on other gear and weapons."] = true -- *v3
	L["Autocomplete"] = true -- *v3
	L["The autocomplete box that pops up when you send mail, invite people to a group etc."] = true -- *v3
	L["TradeSkill"] = true -- *v3
	L["The tradeskill windows where you craft items."] = true -- *v3
	L["ItemText"] = true -- *v3
	L["The itemtext frame for books, signs, etc."] = true -- *v3
	L["Trade"] = true -- *v3
	L["The trade window when trading with another player."] = true -- *v3
	L["Void Storage UI"] = true -- *v3
	L["The Void Storage interface"] = true -- *v3
	L["Tutorials"] = true -- *v3
	L["The game tutorials for new players"] = true -- *v3
	L["Transmogrification UI"] = true -- *v3
	L["The item transmogrification window where you style your items to look like other items"] = true -- *v3
	L["Trainers"] = true -- *v3
	L["The trainer interface where you learn new skills and abilities from"] = true -- *v3
	L["Tabard UI"] = true -- *v3
	L["The tabard designer interface"] = true -- *v3
	L["Socketing UI"] = true -- *v3
	L["The item socketing UI where you add or remove gems from your gear"] = true -- *v3
	L["Reforging UI"] = true -- *v3
	L["The reforging UI where you redistribute secondary stats on your gear"] = true -- *v3
	L["PvP"] = true -- *v3
	L["The PvP window where you queue up for Battlegrounds and Arenas, and manage your teams"] = true -- *v3
	L["Petitions"] = true -- *v3
	L["Petition request such as Guild- and Arena charters"] = true -- *v3
	L["Macro UI"] = true -- *v3
	L["The window where you manage your macros"] = true -- *v3
	L["Dungeon Journal"] = true -- *v3
	L["Instance descriptions, boss abilities and loot tables"] = true -- *v3
	L["Dungeon Finder"] = true -- *v3
	L["Where you browse available dungeons, raids, scenarios and challenges"] = true -- *v3
	L["Friends"] = true -- *v3
	L["The friends frame"] = true -- *v3
	L["Guild UI"] = true -- *v3
	L["The main guild interface"] = true -- *v3
	L["Guild Control UI"] = true -- *v3
	L["The window where you create, modify and delete the guild ranks and their permissions"] = true -- *v3
	L["Guild Finder UI"] = true -- *v3
	L["The window where you browser for guilds"] = true -- *v3
	L["Guild Registrar"] = true -- *v3
	L["The guild registrar interface where you buy petitions and create new guilds"] = true -- *v3
	L["Guild Invite"] = true -- *v3
	L["The guild invite frame where you accept or decline a guild invitation"] = true -- *v3
	L["Inspect UI"] = true -- *v3
	L["The window where you inspect another player's gear, talents and PvP teams"] = true -- *v3
	L["Black Market UI"] = true -- *v3
	L["The black market interface"] = true -- *v3
	L["Item Upgrade UI"] = true -- *v3
	L["The window where you upgrade the item level of your gear"] = true -- *v3
end
...
do
	...
	L["Global Styles"] = true -- *v3
	L["Backdrop Opacity"] = true -- *v3
	L["Set the level of transparency for all backdrops"] = true -- *v3
	L["Load Module"] = true
	L["Module Selection"] = true
	L["Choose which modules that should be loaded"] = true
	L["Never load this module"] = true
	L["Load this module unless an addon with similar functionality is detected"] = true
	L["Settings"] = true -- *v3
	L["Adjust the settings for this module"] = true -- *v3
...
do
	...
	L["Changing these settings requires the UI to be reloaded in order to complete."] = true -- *v3
end
...
do
	...
	L["Cancel current position changes"] = true -- *v3
	L["Reset to default position"] = true -- *v3
	L["<Left-Click to toggle this category>"] = true -- *v3
	L["<Shift-Click to reset all frames in this category>"] = true -- *v3
	L["The frame '%s' is now locked"] = true -- *v3
	L["The group '%s' is now locked"] = true -- *v3
	L["All frames '%s' are now locked"] = true -- *v3
	L["The frame '%s' is now unlocked"] = true -- *v3
	L["The group '%s' is now unlocked"] = true -- *v3
	L["All frames are now unlocked"] = true -- *v3
	L["All frames are now locked"] = true -- *v3
	L["No registered frames to unlock"] = true -- *v3
	L["The group '%s' is empty"] = true -- *v3
	L["Configuration Mode"] = true -- *v3
	L["Frames are now unlocked for movement."] = true -- *v3
	L["<Left-Click once to raise a frame to the front>"] = true -- *v3
	L["<Left-Click and drag to move a frame>"] = true -- *v3
	L["<Left-Click+Shift to lock a frame into position>"] = true -- *v3
	L["<Right-Click a frame for additional options>"] = true -- *v3
	L["Reset all frames to their default positions"] = true -- *v3
	L["Cancel all current position changes"] = true -- *v3
	L["Lock all frames"] = true -- *v3
end
...
do
	...
	L["Combat"] = true
	L["CombatLog"] = true
	L["CombatLogs"] = true -- *v3
	L["Developer Tools"] = true -- *v3
	L["Errors"] = true
	L["Fonts"] = true -- *v3
	L["Loot"] = true
	L["Map"] = true -- *v3
