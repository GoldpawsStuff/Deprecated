...
local module = unitframes:NewModule("Pet")
local style = addon .. "_Pet"
...
local defaults = {
	pos = { "BOTTOM", "UIParent", "BOTTOM", 0, 40 + 86};
}
...
module.OnInit = function(self)
	...
	oUF:Factory(function(self)
		...
		module:PlaceAndSave(frame, L["Pet"], db.pos, unpack(defaults.pos))
