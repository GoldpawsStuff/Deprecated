...
local module = parent:NewModule("EasyChat")
...
module.OnInit = function(self)
	...
	hooksecurefunc("FCF_ResetChatWindows", proxy)
end

module.OnEnable = function(self)
	self:RegisterEvent("PLAYER_ALIVE", setNames)
	self:RegisterEvent("PLAYER_LOGIN", setNames)
end

module.OnDisable = function(self)
	self:UnregisterEvent("PLAYER_ALIVE", setNames)
	self:UnregisterEvent("PLAYER_LOGIN", setNames)
end