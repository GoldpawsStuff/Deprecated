local L = LibStub("gLocale-2.0"):NewLocale((select(1, ...)), "zhTW", false)
...
do
	...
	L["TotemBar"] = "圖騰列" -- *v3
	L["MicroMenu"] = "微型選單" -- *v3
	L["ActionBar%s"] = "動作列 %s" -- *v3
	L["ExtraActionButton"] = "額外的動作列" -- *v3
	L["Set to vertical orientation"] = "垂直排列" -- *v3
	L["Set to horizontal orientation"] = "水平排列" -- *v3
	L["Set number of buttons on each row"] = "每一行按鈕數量" -- *v3
	L["Show always"] = "總是顯示" -- *v3
	L["Show on mouseover"] = "滑鼠懸停顯示" -- *v3
	L["Hide always"] = "總是隱藏" -- *v3
end
...
do
	...
	L["Micro Menu"] = "微型選單" -- *v3
	L["Shapeshift/Aspect/Stance Bar"] = "姿態列" -- *v3
	L["Pet ActionBar"] = "寵物列" -- *v3
	L["Leftmost Side ActionBar [5]"] = "右側動作列 [5]" -- *v3
	L["Rightmost Side ActionBar [4]"] = "右側動作列 [4]" -- *v3
	L["Bottom Right ActionBar [3b]"] = "底部右邊動作列 [3b]" -- *v3
	L["Bottom Left ActionBar [3a]"] = "底部左邊動作列 [3a]" -- *v3
	L["Bottom ActionBar [2]"] = "底部動作列 [2]" -- *v3
	L["Main ActionBar [1]"] = "主要動作列 [1]" -- *v3
	
	L["Show the bottom ActionBar [2]"] = "顯示底部動作列 [2]" -- *v3
	L["Show the bottom left ActionBar [3a]"] = "顯示底部左邊動作列 [3a]" -- *v3
	L["Show the bottom right ActionBar [3b]"] = "顯示底部右邊動作列 [3b]" -- *v3
	L["Show the rightmost side ActionBar [4]"] = "顯示右側動作列 [4]"
	L["Show the leftmost side ActionBar [5]"] = "顯示右側動作列 [5]"
	...
	L["VehicleExitButton"] = "離開載具按鈕" -- *v3

	-- L["Show the Totem Bar"] = "顯示圖騰動作列" -- doesn't exist anymore
	...
	L["Button Size"] = "按鈕大小"
	L["Set the size of the bar's buttons"] = "設定動作列按鈕大小"
	L["Bar Width"] = "動作列寬度" -- *v3
	...
	L["Page Switching"] = "切換主要動作列" -- *v3
	L["Here you can enable extra pageswitching for the main ActionBar for some classes."] = "你可以啟用在某些職業下切換主要動作列" -- *v3
	L["Use Druid Prowl Bar"] = "使用德魯依潛行動作列" -- *v3
	L["Enabling this will switch to a separate bar when you use Prowl"] = "獨立的潛行動作列" -- *v3
	L["Use Warlock Metamorphosis Bar"] = "使用術士惡魔化身動作列" -- *v3
	L["Enabling this will switch to a separate bar when Metamorphosis is active"] = "獨立的惡魔化身動作列" -- *v3
	L["Use Rogue Shadow Dance Bar"] = "使用盜賊暗影之舞動作列" -- *v3
	L["Enabling this will switch to a separate bar when Shadow Dance is active"] = "獨立的暗影之舞動作列" -- *v3
	L["Use Warrior Stance Bars"] = "使用戰士姿態動作列" -- *v3
	L["Enabling this will switch to a separate bar for each of your stances"] = "每個姿態都有獨立的動作列" -- *v3
...
do
	...
	L["Display remaining time as a timer bar instead of text"] = "使用時鐘樣式替代文字顯示剩餘時間" -- *v3
	L["Consolidate Buffs"] = "整合增減益圖示" -- *v3
...
do
	...
	L["Click here to apply the default layout with categories, sorting and empty space compression."] = "點擊這裡套用預設版面，依照分類排序及壓縮可用空間" -- *v3
...
-- Merchant: Menu
do
	L["Here you can configure the options for automatic actions upon visiting a merchant, like selling junk and repairing your armor."] = "這裡你可以設定開啟商店時自動操作的選項，如販賣粗糙等級物品和修理你的裝備。"
	L["Automatically repair your armor and weapons"] = "自動修理裝備和武器"
	L["Enabling this option will show a detailed report of the automatically sold items in the default chat frame. Disabling it will restrict the report to gold earned, and the cost of repairs."] = "開啟此選項將在預設的聊天視窗中顯示自動販售的詳細報告，關閉它則不顯示獲得的金錢及修理裝備的花費。"
	L["Automatically sell poor quality items"] = "自動販賣粗糙等級物品"
	L["Enabling this option will automatically sell poor quality items in your bags whenever you visit a merchant."] = "開啟此選項會在你開啟商店時自動販售你背包中粗糙等級物品。"
	L["Show detailed sales reports"] = "顯示販售詳細報告"
	L["Enabling this option will automatically repair your items whenever you visit a merchant with repair capability, as long as you have sufficient funds to pay for the repairs."] = "當你有足夠的金錢時，啟用此選項會在你開啟商店時自動修理裝備。"
	L["Use your available Guild Bank funds to when available"] = "如果可以，使用公會銀行的資金。"
	L["Enabling this option will cause the automatic repair to be done using Guild funds if available."] = "啟用此選項將會使用公會銀行修理裝備。"
end
...
do
	...
	L["<Left-Click to toggle the Calendar>"] = "<左鍵點擊開啟行事曆>" -- *v3
end
...
do
	...
	L["Show seconds"] = "顯示秒"
	L["Use 24 hour time"] = "24小時制"
	L["Display the server time instead of the local time"] = "顯示伺服器時間而非本地時間" -- *v3
	...
	L["Only show the clock when hovering over the Minimap"] = "只有在滑鼠旋停小地圖上才顯示時鐘" -- *v3
	L["Display the current location"] = "顯示目前地區" -- *v3
	L["Only show the current location when hovering over the Minimap"] = "只有在滑鼠旋停小地圖上才顯示目前地區" -- *v3
	L["Display the calendar button"] = "顯示行事曆按鈕" -- *v3
	L["Only show the calendar button when hovering over the Minimap"] = "只有在滑鼠旋停小地圖上才顯示行事曆按鈕" -- *v3
end
...
do
	...
	L["Show Class Colors in Unit Nameplates for enemies"] = "在敵方的名條上顯示職業顏色" -- *v3	
...
do
	...
	L["Panel Styles"] = "面板樣式" -- *v3
	L["Color borders in the color of your class"] = "邊框顏色依照你的職業類型顯示" -- *v3
	...
	L["XP-, Rep- & Capture Bars"] = "經驗、聲望、佔領條" -- *v3
	
	L["Panels & Backdrops"] = "面板及動作列邊框" -- *v3
	L["Left Infopanel"] = "左側資訊面板" -- *v3
	L["Right Infopanel"] = "右側資訊面板" -- *v3
	L["Bottom Backdrop"] = "底部動作列邊框" -- *v3
	L["Bottom Left Backdrop"] = "底部左側動作列邊框" -- *v3
	L["Bottom Right Backdrop"] = "底部右側動作列邊框" -- *v3
	L["Side Backdrop"] = "右側動作列邊框" -- *v3

	L["<Left-Click to open all bags>"] = "<左鍵點擊開啟所有背包>"
	L["<Left-Click to toggle backpack>"] = "<左鍵點擊開啟背包>"
...
-- Panels: menu
do
	L["Here you can change the settings and visibility of the various info panels and backdrops in the UI."] = "這裡你可以設定及顯示UI各種資訊面板及背景。" -- *v3
	...
	L["Visible Panels"] = "顯示面板"
	L["Here you can decide which of the UI panels should be visible. They can still be moved with |cFF4488FF/glock|r when hidden."] = "這裡你可以設定是否顯示 UI 面板，它們仍然可以在隱藏狀態下透過 |cFF4488FF/glock|r 指令移動。"
	L["Show the bottom right UI panel"] = "顯示右下角面板"
	L["Show the bottom left UI panel"] = "顯示左下角面板"
	L["Bottom Right Panel"] = "右下角面板"
	L["Bottom Left Panel"] = "左下角面板"
	L["Visible Backdrops"] = "顯示動作列邊框" -- *v3
	L["Here you can decide which of the backdrops should be visible."] = "這裡你可以設定要顯示哪個動作列的邊框。" -- *v3
	L["Bottom Backdrop"] = "底部動作列邊框" -- *v3
	L["Bottom Left Backdrop"] = "底部左側動作列邊框" -- *v3
	L["Bottom Right Backdrop"] = "底部右側動作列邊框" -- *v3
	L["Side Backdrop"] = "側邊動作列邊框" -- *v3
end
...
do
	...
	L["Color unit tooltips borders and healthbars according to player class or NPC reaction"] = "根據玩家職業或NPC狀態用顏色顯示在提示邊框及單位血條。" -- *v3
...
do
	...
	L["Can't change the Set Focus key while engaged in combat!"] = "戰鬥中無法更改專注目標快速鍵設定"
end
...
do
	...
	L["Player"] = "玩家"
	L["ClassBar"] = "職業專屬資源列"
	L["The ClassBar is a larger display of class related information like Holy Power, Runes, Eclipse and Combo Points. It is displayed close to the on-screen CastBar and is designed to more easily track your most important resources."] = "職業專屬資源列顯示職業相關如聖能、符文，蝕星蔽月及連擊點數。它顯示在施法條附近用來更輕鬆地監視你重要的資源。"
	L["Enable large movable classbar"] = "使用大型可移動的職業專屬資源列"
	L["This will enable the large on-screen classbar"] = "這會啟用大型職業專屬資源列"
	L["Only in Combat"] = "只在戰鬥中顯示"
	L["Disable integrated classbar"] = "關閉整合式資源列"
	L["This will disable the integrated classbar in the player unitframe"] = "這會在玩家頭像UI中關閉整合式資源列。"
	L["Show player auras"] = "顯示玩家光環"
	L["This decides whether or not to show the auras next to the player frame"] = "這裡設定是否在玩家頭像旁顯示光環"
	
	L["Target"] = "目標"
	L["Show target auras"] = "顯示目標光環"
	L["This decides whether or not to show the auras next to the target frame"] = "這裡設定是否在目標頭像旁顯示光環"
end
...
do
	...
	L["Target"] = "目標" -- *v3
	L["Pet"] = "寵物" -- *v3
	L["Target of Target"] = "目標的目標" -- *v3
	L["Focus"] = "專注目標" -- *v3
	L["Party"] = "隊伍" -- *v3
	L["15 Player Raid"] = "15人團隊" -- *v3
	L["40 Player Raid Healer"] = "40人團隊 Healer" -- *v3
	L["40 Player Raid DPS"] = "40人團隊 DPS" -- *v3
	L["Arena"] = "增減益" -- *v3
	L["Boss"] = true -- *v3
end
...
do
	...
	L["Select categories from the list on the left. |nYou can choose multiple categories at once to narrow down your search.|n|nSelected categories will be displayed on top of the listing, |nand clicking them again will deselect them!"] = "從左側列表中選擇所需的類別。|n您可以一次選擇多個類別來縮小您的搜索結果。|n|n已選擇的類別會顯示在最上層|n再點及一次會取消選取。"
	...
	L["Let the 'B' key toggle my bags"] = "使用 B 鍵開啟背包"
	
	-- castbars
	L["Player Castbar"] = "玩家施法條" -- *v3
	L["Target Castbar"] = "目標施法條" -- *v3
	L["Focus Castbar"] = "專注目標施法條" -- *v3
	L["Pet Castbar"] = "寵物施法條" -- *v3
...
do
	...
	L["Whisper focus"] = "密語給專注目標"
	L["Whisper target"] = "密語給目標"
end
...
--------------------------------------------------------------------------------------------------
do
	L["Copy settings between characters"] = "角色間複製設定" -- *v3
	L["Save"] = "儲存" -- *v3
	L["Restore"] = "回復" -- *v3

	L["Goldpaw"] = "|cFFFF7D0AGoldpaw|r" -- my class colored name. no changes needed here.
	L["%s loaded and ready"] = "%s 已載入備妥" -- *v3
	L["|cFF4488FF/glock|r to activate config mode"] = "|cFF4488FF/glock|r 開啟設定模式" -- *v3
	L["|cFF4488FF/bind|r to activate binding mode"] = "|cFF4488FF/bind|r 開啟按鍵綁定" -- *v3
	L["|cFF4488FF/gui|r for additional options"] = "|cFF4488FF/gui|r 開啟選項" -- *v3
	...
	L["Reload the user interface"] = "重新載入使用者介面" -- *v3
	L["Blizzard Customer Support"] = "暴雪客服" -- *v3
	L["Toggle movable frames"] = "開啟可移動式框架" -- *v3
	L["Toggle hover keybind mode"] = "啟用滑鼠懸停綁定快速鍵模式" -- *v3
	L["Additional Keybinds"] = "額外的快速鍵綁定" -- *v3
	L["TSM Post/Cancel"] = true -- *v3

	-- chat commands
	L["Activating Primary Specialization"] = "啟用主要天賦" -- *v3
	L["Activating Secondary Specialization"] = "啟用第二天賦" -- *v3
	L["%s has been temporarily disabled. Type /enablegui to enable it."] = "%s 已被暫時禁用，輸入 /enablegui 啟用。" -- *v3
	
	-- frame groups (objects movable with /glock)
	L["Unitframes"] = "單位框架" -- *v3
	L["Frames like the player, target, raid, focus, pet etc"] = "如玩家、目標、團隊、專注目標、寵物等框架。" -- *v3
	L["Actionbars"] = "動作列" -- *v3
	L["Frames containing shortcut buttons to abilities, macros etc"] = "含有技能、巨集等快速鍵的框架。" -- *v3
	L["Panels"] = "面板" -- *v3
	L["Various UI panels providing information, |rincluding the minimap and bottom left and right infopanels"] = "各種提供訊息的 UI 面板|r包含小地圖和左右兩邊底部的資訊面板。" -- *v3
	L["Floaters"] = "浮動框架" -- *v3
	L["Various uncategorized elements like the objective tracker, |rthe durability frame, the vehicle seat indicator etc"] = "各種未分類的元件如目標追蹤器|r裝備耐久度、車輛載具座位等。" -- *v3
	L["Auras"] = "光環" -- *v3
	L["Your buffs and debuffs"] = "玩家增益及減益圖示" -- *v3
	L["Castbars"] = "施法條" -- *v3
	L["Unit castbars, mirror timers, BG timers, etc"] = "單位施法條、小時鐘、戰場計時等。" -- *v3
	
	-- floaters (various movable frame names)
	L["Vehicle"] = "載具" -- *v3
	L["Objectives"] = "任務清單" -- *v3
	L["Alternate Power"] = "能量條" -- *v3
	L["Tickets"] = true -- *v3
	L["Durability"] = "耐久度" -- *v3
	L["Ghost"] = "鬼魂" -- *v3
	L["WorldStateScore"] = "戰場" -- *v3
	L["ExtraActionButton"] = "額外的動作列" -- *v3
	L["Achievement and Dungeon Alert Frame"] = "成就及副本警示框架" -- *v3
	
	-- auto disable
	L["The '%s' module was disabled due to the addon '%s' being loaded."] = "%s 模組因 %s 插件已載入而關閉" -- *v3
	
	-- skin names and descriptions
	L["Skins"] = "外觀" -- *v3
	L["Skins the '%s' addon"] = "改變 %s 插件外觀" -- *v3
	L["Here you can decide which elements should be skinned to match the rest of the UI, and which should keep their default appearance."] = "你可以決定要改變哪些元件的外觀以搭配其他UI，而哪些則保留其預設的外觀。" -- *v3
	L["Debug Tools"] = "除錯工具" -- *v3
	L["Debug tools such as the /framestack or /eventtrace frames"] = "如 /framestack 或是 /eventtrace 框架" -- *v3
	L["MovePad"] = true -- *v3
	L["The movepad which allows you to move and jump with your mouse"] = "讓你用滑鼠控制人物移動和跳躍的插件" -- *v3
	L["Alert Frames"] = "警告框架" -- *v3
	L["General alerts such as new achievements, dungeons completed, etc"] = "一般警示如完成新的成就或副本等等" -- *v3
	L["Color Picker"] = "顏色選擇" -- *v3
	L["The color wheel"] = "色盤" -- *v3
	L["GameMenu"] = "遊戲選單" -- *v3
	L["The main game menu"] = "主要的遊戲選單" -- *v3
	L["Ghost"] = true -- *v3
	L["The button returning you to a graveyard as a ghost"] = "將你的鬼魂傳回墓地的按鈕" -- *v3
	L["Quest Gossip"] = "任務資訊" -- *v3
	L["General gossip when talking to quest givers"] = "與任務NPC交談時顯示的任務資訊" -- *v3
	L["Merchant"] = "商店" -- *v3
	L["The buy/sell window when talking to merchants"] = "與商人交談時顯示的買賣視窗" -- *v3
	L["Opacity"] = "透明度" -- *v3
	L["The opacity selector"] = "透明度選擇器" -- *v3
	L["Quest Log"] = "任務紀錄" -- *v3
	L["Main quest log"] = "主要的任務紀錄" -- *v3
	L["Quest Greeting"] = "任務歡迎" -- *v3
	L["The greeting window when talking to quest givers"] = "與任務NPC交談時顯示的任務歡迎視窗" -- *v3
	L["Ready Check"] = "團隊確認" -- *v3
	L["The ready check popup when in a group"] = "組隊時準備就緒的彈跳視窗" -- *v3
	L["Roll Poll"] = true -- *v3
	L["The roll poll popup when in a group"] = "團隊中骰取裝備的介面" -- *v3
	L["Stack Split"] = "堆疊分割" -- *v3
	L["The stack split frame when splitting stacks in your bank or bags"] = "銀行或背包堆疊框架" -- *v3
	L["Popups"] = "彈跳視窗" -- *v3
	L["The popup windows with yes/no or other queries"] = "顯示yes/no或是其他問題的視窗" -- *v3
	L["Taxi"] = "飛行地圖" -- *v3
	L["The flight map when talking to flight masters"] = "與飛行管理員交談時顯示的地圖" -- *v3
	L["Ticket Status"] = true -- *v3
	L["The ticket status button for active support tickets"] = true -- *v3
	L["Objectives Tracker"] = "任務追蹤" -- *v3
	L["The quest- and achievement tracker"] = "任務及成就追蹤器" -- *v3
	L["World Score"] = "世界積分" -- *v3
	L["The on-screen score (battlegrounds, dungeon waves, world PvP objectives etc)"] = true -- *v3
	L["Battleground Score"] = "戰場比數" -- *v3
	L["The Battleground score frame"] = "戰場雙方陣營比數" -- *v3
	L["Achievements"] = "成就" -- *v3
	L["The achievement- and statistic frames"] = "成就及統計框架" -- *v3
	L["Archeology"] = "考古" -- *v3
	L["The Archeology UI"] = "考古界面" -- *v3
	L["Auction House"] = "拍賣場" -- *v3
	L["The Auction House Interface"] = "拍賣場介面" -- *v3
	L["Barber Shop"] = "理髮店" -- *v3
	L["The Barber Shop Interface, where you change your hair, facial hair and markings."] = "當你改變你的髮型、鬍鬚及裝扮時顯示的介面" -- *v3
	L["Mailbox"] = "信箱" -- *v3
	L["Your Mail Inbox and Send Mail windows."] = "收信與寄信視窗" -- *v3
	L["Character"] = "角色資訊" -- *v3
	L["The window where you see your currently equipped gear, set your title and manage your equipment sets."] = "顯示你目前裝備，設定頭銜及套裝管理的視窗" -- *v3
	L["Guild Bank"] = "公會銀行" -- *v3
	L["The Guild Bank window with your guild's gold and items."] = "公會銀行視窗" -- *v3
	L["Calendar"] = "行事曆" -- *v3
	L["The in-game calendar"] = "遊戲裡的行事曆" -- *v3
	L["Dressing Room"] = "試衣間" -- *v3
	L["The dressing room where your character can try on other gear and weapons."] = "可以預覽裝備及武器的試衣間" -- *v3
	L["Autocomplete"] = "自動完成" -- *v3
	L["The autocomplete box that pops up when you send mail, invite people to a group etc."] = "當你寄信或是邀請某人組隊時彈出的視窗" -- *v3
	L["TradeSkill"] = "專業技能" -- *v3
	L["The tradeskill windows where you craft items."] = "製作物品視窗" -- *v3
	L["ItemText"] = true -- *v3
	L["The itemtext frame for books, signs, etc."] = true -- *v3
	L["Trade"] = "交易" -- *v3
	L["The trade window when trading with another player."] = "與他人交易時顯示的視窗" -- *v3
	L["Void Storage UI"] = "虛空倉庫" -- *v3
	L["The Void Storage interface"] = "虛空倉庫界面" -- *v3
	L["Tutorials"] = "新手教學" -- *v3
	L["The game tutorials for new players"] = "遊戲新手教學界面" -- *v3
	L["Transmogrification UI"] = "塑形" -- *v3
	L["The item transmogrification window where you style your items to look like other items"] = "將你的裝備塑造成其他裝備外觀的視窗" -- *v3
	L["Trainers"] = "訓練員" -- *v3
	L["The trainer interface where you learn new skills and abilities from"] = "學習職業技能或專業技能的視窗" -- *v3
	L["Tabard UI"] = "外袍" -- *v3
	L["The tabard designer interface"] = "外袍設計界面" -- *v3
	L["Socketing UI"] = "寶石插槽" -- *v3
	L["The item socketing UI where you add or remove gems from your gear"] = "讓你在裝備上嵌入或移除寶石的界面" -- *v3
	L["Reforging UI"] = "重鑄" -- *v3
	L["The reforging UI where you redistribute secondary stats on your gear"] = "讓你的裝備重新分配次要屬性的界面" -- *v3
	L["PvP"] = true -- *v3
	L["The PvP window where you queue up for Battlegrounds and Arenas, and manage your teams"] = "排隊等候戰場、競技場及團隊管理" -- *v3
	L["Petitions"] = true -- *v3
	L["Petition request such as Guild- and Arena charters"] = true -- *v3
	L["Macro UI"] = "巨集" -- *v3
	L["The window where you manage your macros"] = "管理你巨集的界面" -- *v3
	L["Dungeon Journal"] = "地城導覽手冊" -- *v3
	L["Instance descriptions, boss abilities and loot tables"] = "副本說明、王的技能及掉落物品清單" -- *v3
	L["Dungeon Finder"] = "地城搜尋器" -- *v3
	L["Where you browse available dungeons, raids, scenarios and challenges"] = "瀏覽可用的副本、團隊情境及挑戰模式。" -- *v3
	L["Friends"] = "好友" -- *v3
	L["The friends frame"] = "好友視窗" -- *v3
	L["Guild UI"] = "公會 UI" -- *v3
	L["The main guild interface"] = "主要的公會界面" -- *v3
	L["Guild Control UI"] = "公會管理 UI" -- *v3
	L["The window where you create, modify and delete the guild ranks and their permissions"] = "創建、修改、刪除公會及權限的視窗" -- *v3
	L["Guild Finder UI"] = "搜尋公會 UI" -- *v3
	L["The window where you browser for guilds"] = "讓你瀏覽所有公會的視窗" -- *v3
	L["Guild Registrar"] = "公會登記" -- *v3
	L["The guild registrar interface where you buy petitions and create new guilds"] = true -- *v3
	L["Guild Invite"] = "工會邀請" -- *v3
	L["The guild invite frame where you accept or decline a guild invitation"] = "讓你接受或拒絕工會邀請的視窗" -- *v3
	L["Inspect UI"] = "查看人物 UI" -- *v3
	L["The window where you inspect another player's gear, talents and PvP teams"] = "讓你查看其他人物的裝備、天賦、PVP 團隊的視窗" -- *v3
	L["Black Market UI"] = "黑市 UI" -- *v3
	L["The black market interface"] = "黑市界面" -- *v3
	L["Item Upgrade UI"] = "裝備升級 UI" -- *v3
	L["The window where you upgrade the item level of your gear"] = "升級裝備等級的視窗" -- *v3
end

-- menu
do
	L["Copy settings from another character"] = "從其他角色複製設定"
	L["This will copy all settings for the addon and all its sub-modules from the selected character to your currently active character"] = "這將從選定的角色複製所有包含子模組的設定到目前角色"
	L["This will only copy the settings for this specific sub-module from the selected character to your currently active character"] = "這只會從選定的角色複製該子模組的設定到目前角色"
	L["UI Scale"] = "介面縮放比例"
	...
	L["Global Styles"] = "全局樣式" -- *v3
	L["Backdrop Opacity"] = "背景透明度" -- *v3
	L["Set the level of transparency for all backdrops"] = "設定背景透明度" -- *v3
	L["Load Module"] = "載入模組"
	L["Module Selection"] = "模組選擇"
	L["Choose which modules that should be loaded"] = "選擇要載入的模組"
	...
	L["Settings"] = "設定" -- *v3
	L["Adjust the settings for this module"] = "調整模組設定" -- *v3
...
do
	...
	L["Changing these settings requires the UI to be reloaded in order to complete."] = "更改這些設定需要重新載入UI以完成設定" -- *v3
end
...
do
	...
	-- L["<Right-Click for options>"] = "<右鍵點擊開啟選項>" -- the panel module supplies this one
	-- L["Lock"] = "鎖定"
	L["Center horizontally"] = "水平置中"
	L["Center vertically"] = "垂直置中"
	L["Cancel current position changes"] = "取消目前位置變更" -- *v3
	L["Reset to default position"] = "回復預設位置" -- *v3
	L["<Left-Click to toggle this category>"] = "<左鍵點擊開啟此分類>" -- *v3
	L["<Shift-Click to reset all frames in this category>"] = "<Shift鍵重置此分類所有框架>" -- *v3
	L["The frame '%s' is now locked"] = "%s 框架已鎖定" -- *v3
	L["The group '%s' is now locked"] = "%s 群組已鎖定" -- *v3
	L["All frames '%s' are now locked"] = "所有 %s 框架已鎖定" -- *v3
	L["The frame '%s' is now unlocked"] = "%s 框架已解除鎖定" -- *v3
	L["The group '%s' is now unlocked"] = "%s 群組已解除鎖定" -- *v3
	L["All frames are now unlocked"] = "所有框架已解除鎖定" -- *v3
	L["All frames are now locked"] = "所有框架已鎖定" -- *v3
	L["No registered frames to unlock"] = "所有框架已解除鎖定" -- *v3
	L["The group '%s' is empty"] = "%s 群組是空的" -- *v3
	L["Configuration Mode"] = "設定" -- *v3
	L["Frames are now unlocked for movement."] = "框架已解鎖可移動" -- *v3
	L["<Left-Click once to raise a frame to the front>"] = "<左鍵點擊一次將框架移到前景>" -- *v3
	L["<Left-Click and drag to move a frame>"] = "<左鍵點擊並拖曳移動框架>" -- *v3
	L["<Left-Click+Shift to lock a frame into position>"] = "<左鍵+Shift在此位置鎖定框架>" -- *v3
	L["<Right-Click a frame for additional options>"] = "<右鍵點擊開啟額外的選項>" -- *v3
	L["Reset all frames to their default positions"] = "回復所有框架預設位置" -- *v3
	L["Cancel all current position changes"] = "取消所有位置變更" -- *v3
	L["Lock all frames"] = "鎖定所有框架" -- *v3
end
...
do
	...
	L["Combat"] = "戰鬥"
	L["CombatLog"] = "戰鬥紀錄"
	L["CombatLogs"] = "戰鬥紀錄" -- *v3
	L["Developer Tools"] = "開發用工具" -- *v3
	L["Errors"] = "錯誤訊息"
	L["Fonts"] = "字型" -- *v3
	L["Loot"] = "戰利品"
	L["Map"] = "地圖" -- *v3
