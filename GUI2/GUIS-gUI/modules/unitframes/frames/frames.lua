...
UnitSpecific = {
	player = function(self, unit)
		self.Power:SetHeight(settings.player.powerbarsize)
		self.Power:SetPoint("BOTTOM", 0, 0)

		self.Health:SetPoint("TOP", self.Power, "TOP", 0, settings.player.powerbarsize + 1)
	...
	target = function(self, unit)
		...
		self.Health:SetPoint("TOP", self.Power, "TOP", 0, settings.target.powerbarsize + 1)
...
Shared = function(self, unit)
	...
	Power:SetHeight(settings[unit].powerbarsize)
