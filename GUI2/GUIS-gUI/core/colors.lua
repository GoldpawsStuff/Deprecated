...
C.PowerBarColor = setmetatable({
	...
	["ENERGY"] = { r = 1.00 * 0.85; g = 1.00 * 0.85; b = 0.00 * 0.85 };
	["FOCUS"] = { r = 1.00 * 0.85; g = 0.50 * 0.85; b = 0.25 * 0.85 };
	["FUEL"] = { r = 0.00 * 0.85; g = 0.55 * 0.85; b = 0.50 * 0.85 };
	["HOLY_POWER"] = { r = 0.95 * 0.85; g = 0.90 * 0.85; b = 0.60 * 0.85 };
	["MANA"] = { r = 0.00 * 0.85; g = 0.00 * 0.85; b = 1.00 * 0.85 };
	["RAGE"] = { r = 1.00 * 0.85; g = 0.00 * 0.85; b = 0.00 * 0.85 };
	["RUNES"] = { r = 0.50 * 0.85; g = 0.50 * 0.85; b = 0.50 * 0.85 };
	["RUNIC_POWER"] = { r = 0.00 * 0.85; g = 0.82 * 0.85; b = 1.00 * 0.85 };
